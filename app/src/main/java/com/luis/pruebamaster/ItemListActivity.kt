...
import com.luis.pruebamaster.dummy.DummyContent
...
import com.luis.pruebamaster.dummy.DummyItem
import kotlinx.android.synthetic.main.item_list_content.view.*
    ...
    private fun peticionPosts() {
        ...
        doAsync {
            ...
            try {
                ...
                val respuesta = URL("http://35.173.134.150/wordpress/?rest_route=/wp/v2/posts").readText()
                // parsing data
